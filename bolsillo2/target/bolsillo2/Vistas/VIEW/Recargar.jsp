	...
	<section>
		<div class="contenedor">
			<form action="../Loguin.php" class="form" name="login" method="POST">
				...
				<input type="text" class="form-input" id="saldo" placeholder="Su Saldo es de"> 

				<label for="saldodes" class="form-label">Saldo Despues de Recargar</label>
				<input type="number" class="form-input" id="saldodes" placeholder="Su Saldo Despues de Recargar es">

				<input type="submit" class="btn-submit" value="Recargar">
			</form>
		</div>
	</section>
	<br><br>
